...
namespace WebBlogCore5.Helpers
{
    //Dùng để định nghĩa các class hay dùng đến nhiều nhất
    public static class Utilities
    {
        ...
        //Hàm này dùng để tạo chuỗi 5 kí tự ngẫu nhiên và lưu vào db.Account -> Salt
        //Rồi dùng (pass + salt) -> md5 -> save to db
